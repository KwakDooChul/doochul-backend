...
public class Product extends BaseEntity {
    ...
    public static Product of(User user, ProductSaveRequest productSaveRequest) {
        return new Product(null, productSaveRequest.name(), productSaveRequest.type(), user,
                productSaveRequest.count());
    }
}
