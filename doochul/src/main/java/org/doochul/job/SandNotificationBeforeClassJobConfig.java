...
@Configuration
public class SandNotificationBeforeClassJobConfig {
    private static final int CHUNK_SIZE = 10;

    private final DataSource dataSource;
    private final SendNotificationItemWriter sendNotificationItemWriter;

    public SandNotificationBeforeClassJobConfig(final DataSource dataSource, final SendNotificationItemWriter sendNotificationItemWriter) {
        this.dataSource = dataSource;
        this.sendNotificationItemWriter = sendNotificationItemWriter;
    }

    @Bean
    public Job sendNotificationBeforeClassJob(JobRepository jobRepository, PlatformTransactionManager transactionManager) throws Exception {
    ...
    private PagingQueryProvider createQueryProvider() throws Exception {
        ...
        queryProvider.setSelectClause("u.device_token AS student_token, u.name AS student_name, t.name AS teacher_name, l.started_at");
